...
public class Pilha {
    ...
    private char[] pilhaArray;   //vetor??? Isso mesmo ...usamos ele para implementar pilha
...
//--------------------------------------------------------------
    ...
    public Pilha(int s) // construtor
    {
        ...
        pilhaArray = new char[maxSize];  // criamos aqui o vetor que servirá de pilha
        top = -1;                // top vale -1 porque ainda não tem nenhum item!
    }
//--------------------------------------------------------------

    public void inserir(char j) // insere um item no topo da pilha
    {
...
//--------------------------------------------------------------
    ...
    public char remove() // remove o item no topo da pilha
    {
...
//--------------------------------------------------------------
    ...
    public char pegaitem() // pega item
    {
